...
realman._right_target.set_world_pose(position=np.array([-0.17, -0.573, 0.81]), orientation=np.array([1.0, 0.0, 0.0, 0.0]))
...
realman._left_target.set_world_pose(position=np.array([0.44, -0.55, 0.79]), orientation=np.array([1.0, 0.0, 0.0, 0.0]))
realman._right_target.set_world_pose(position=np.array([-0.165, -0.573, 0.79]), orientation=np.array([1.0, 0.0, 0.0, 0.0]))

realman.dense_step_action()

realman._left_target.set_world_pose(position=np.array([0.28, -0.55, 0.79]), orientation=np.array([1.0, 0.0, 0.0, 0.0]))
realman._right_target.set_world_pose(position=np.array([-0.165, -0.573, 0.79]), orientation=np.array([1.0, 0.0, 0.0, 0.0]))

realman.dense_step_action()

realman._left_target.set_world_pose(position=np.array([0.28, -0.55, 0.9]), orientation=np.array([1.0, 0.0, 0.0, 0.0]))
realman._right_target.set_world_pose(position=np.array([-0.165, -0.573, 0.9]), orientation=np.array([1.0, 0.0, 0.0, 0.0]))
